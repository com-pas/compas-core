...
public class SclConstants {
    ...
    public static final String XML_DEFAULT_XSD_PATH = "classpath:xsd/SCL2007B/SCL.xsd";
    public static final String JAXB_CONTEXT_PATH = "org.lfenergy.compas.scl2007b.model";
}
